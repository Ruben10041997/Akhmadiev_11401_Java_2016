            ...
            <div class="nav-collapse">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/client/information">Profile</a></li>
...
<div class="subnavbar">
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="active"><a href="/client/"><i></i><span>Home</span> </a> </li>
                <li><a href="/client/information"><i ></i><span>My Information</span> </a> </li>
                <li><a href="/client/addorder"><i ></i><span>Make An Order</span> </a></li>
                <li><a href="/client/myorders"><i ></i><span>My Orders</span> </a></li>
...
<h1>Welcome, ${client.nameoforganization}</h1><br>

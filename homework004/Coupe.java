...
public class Coupe extends SportGearbox implements Car,ClimateControl, MultimediaSystem, Engine {
    ...
    @Override
    public void toDrive() {
        System.out.print("Погнали!");
    }

    @Override
    public void toBrake() {
        System.out.print("Притормозим");
    }

    @Override
    public void toUseHeadlights() {
        System.out.print("Включим ксеноновые фары");
    }

    @Override
    public void toWindowRise() {
        System.out.print("Поднимаем стекло");
    }

    @Override
    public void toCool() {
        System.out.print("Охладим");
    }

    @Override
    public void toWarm() {
        System.out.print("Подогреем");
    }

    @Override
    public void toBlow() {
        System.out.print("Ветерок");
    }
    ...
    public void gainTracrion() {
        ...
        if (engineRpm > 10000){
            ...
            System.out.print("Текущие обороты = " + engineRpm);
    ...
    public BrokenEngine explode() {
        System.out.print("Мотор перегрелся");
        return new BrokenEngine();}

    @Override
    public void toEnableMusic() {
        System.out.print("Включаем попсу");
    }
    ...
    public ClimateControl toEnableCLimateControl() {
        return new ClimateControl() {
            @Override
            public void toCool() {
                System.out.print("Охладить");
            }

            @Override
            public void toWarm() {
                System.out.print("Подогреть");

            }

            @Override
            public void toBlow() {
                System.out.print("Продуть");
            }
        };
    }
